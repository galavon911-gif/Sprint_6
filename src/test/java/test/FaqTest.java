...
class FaqTest {
    ...
    void testFaqAccordionMessages(int index, String expectedAnswer) {
        mainPage.clickAccordionQuestion(index);
        String actualAnswer = mainPage.getAccordionAnswerText(index);
        assertEquals(expectedAnswer, actualAnswer, "Текст ответа в FAQ не совпадает для пункта " + index);
    }
